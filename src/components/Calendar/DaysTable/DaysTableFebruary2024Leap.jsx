export const DaysTableFebruary2024Leap = (props) => {
    return (
        <table style={{color: 'black', width: '100%'}}>
            ...
            <tr style={{height: '26px'}}>
                ...
                <td id="30" onClick={props.handleDaySelection} className="text-center calendar-element-disabled">30</td>
                <td id="31" onClick={props.handleDaySelection} className="text-center calendar-element-disabled">31</td>
