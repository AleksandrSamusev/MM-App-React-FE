export const DaysTableAugust2024 = (props) => {
    return (
        <table style={{color: 'black', width: '100%'}}>
            ...
            <tr style={{height: '26px'}}>
                ...
                <td id="" className="text-center calendar-element-disabled">1</td>
                <td id="" className="text-center calendar-element-disabled">2</td>
                <td id="" className="text-center calendar-element-disabled">3</td>
                <td id="" className="text-center calendar-element-disabled">4</td>
            </tr>
            </tbody>
        </table>
    )
